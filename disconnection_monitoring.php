...
echo"<script> alert('ada disconnection Malalao tatta ..thanks')</script>";
...
<img src="<?php echo$pp; ?>" style="border:5px solid black; width:100%;" height="80"    alt="..." class="img">
  </div>
...
echo number_format($mtcoll/100, 2,'.',',');
 ?>
     ...
     <div class="col-12 p-2" style="margin-top:-26px; margin-left:9px;">


<button type="button" class="btn btn-secondary position-relative m-1 w-40" data-toggle="modal" data-target="#exampleModal" style="font-size:10px; padding:1px; padding-bottom:1px; padding-top:1px; padding-left:4px;padding-right:4px;color:black" >  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-camera text-info" viewBox="0 0 16 16">
  <path d="M15 12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h1.172a3 3 0 0 0 2.12-.879l.83-.828A1 1 0 0 1 6.827 3h2.344a1 1 0 0 1 .707.293l.828.828A3 3 0 0 0 12.828 5H14a1 1 0 0 1 1 1zM2 4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.172a2 2 0 0 1-1.414-.586l-.828-.828A2 2 0 0 0 9.172 2H6.828a2 2 0 0 0-1.414.586l-.828.828A2 2 0 0 1 3.172 4z"/>
  <path d="M8 11a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5m0 1a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7M3 6.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0"/>
</svg> <b>Change Profile </b></button>


<button type="button" class="btn btn-secondary position-relative m-1 " id="logout"  style="font-size:10px; padding:1px; padding-bottom:1px; padding-top:1px; padding-left:25px;padding-right:25px;color:black" ><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"  fill="currentColor" class="bi bi-box-arrow-right text-warning" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0z"/>
  <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z"/>
</svg> <b>Log Out </b></button>
</div>
                  ...
                  ?>
                        <tr class="align-middle " style="color:#ebedef; border-bottom:1px solid #4f5d73;">
                          <td class="text-center"  style="color:#ebedef;">  <span><b> <?php echo$list; ?> </b></span>
                            <div class="avatar "><img class="avatar-img" src="<?php echo$pp1;  ?>" alt="user@email.com"></div>
...
<input type="hidden" id ="name" value="<?php echo $username; ?>">
          ...
          <div class="col-sm-5 mb-3 mt-3">
           ...
           <div class="alert alert-warning" role="alert">Full Paid lang t Mabalin Nga ikkaten T Disconnection Order !</div>
            <input type="number"  maxlength ="12"  class="form-control " placeholder="Enter Account No." id="acc">
