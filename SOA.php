...
$key = $_GET["id"];
?>
  <a id="badge" href="http://kaelco.000.pe/Upgrade/dist/pdf.php?id=<?php echo$key ?>"  target="_blank" class="button-62 m-2"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
...
$ptype = $_GET["ptype"];
    $info_ = mysqli_query($db,"SELECT PTYPE FROM emails WHERE _KEY='$key' LIMIT 1 ");
