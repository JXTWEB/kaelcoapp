...
$find=0;
$sent=0;
   $info1 = mysqli_query($db,"SELECT * FROM  emails WHERE YR_MO == '$currentbillmonthreverse' AND PTYPE = '$ptype' LIMIT 1");
...
if($find ==1){
 ...
 $qry  = "UPDATE `emails` SET `YR_MO` = '$currentbillmonthreverse', `_KEY` = '$key', `_DATE` = '$dateinset1' WHERE `NEWACTS` = '$acc'";
