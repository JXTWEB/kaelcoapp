...
echo number_format($mtcoll/100, 2,'.',',');
 ?>
        ...
        <p class="nav-title p-2  text-center" style="font-size:12px;background-color:#1e1d1d;">LIST OF AGENT, DEPUTIES AND COLLECTOR</p>
...
$new_width = (int)($percentage *100)/$totalWidth ; 
                  ...
                  ?>
                        ...
                        <tr class="align-middle " style="color:#ebedef; border-bottom:1px solid #4f5d73;">
                          ...
                          <td  style="color:#ebedef;width:50%;">
                            ...
                            <div class="small text-medium " style="font-size:9px;"><b><?php echo$onlinename; ?> </b> <br>
                           <span style="font-size:9px;" >Percentage Of total Collection For the Month OF <?php echo $montset; ?></span> 
                             <?php
  echo convertExponentialToDecimal($new_width); ?>%
                          ...
                          <td style ="width:50%;">
                          <div class="small text-medium " style="font-size:9px;">Total Collection
                          <span class="badge   ms-auto text-light" style="font-size:9px;background-color:#1e1d1d;" ><?php
...
echo number_format($mtcoll/100, 2,'.',',');
 ?></span>
                          ...
                          <div class="small text-medium " style="font-size:9px;">Arrears Collected 
                          <span class="badge bg-warning   ms-auto " style="font-size:9px;background-color:black;color:black;" ><?php
