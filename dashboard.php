...
-webkit-text-fill-color: transparent;
   ...
   <p class="nav-title   text-center p-1 " style="font-size:12px;background-color:white;margin:0;color:black; font-weight:bolder;">TOP HIGHTEST COLLECTION</p>
...
?>
                          ...
                          <td class="text-center p-1 box"   style="width:300px;background-color:white;border:3px solid #ebedef;border-radius:10px;">
  <?php if($list == 1 || $list == 2 || $list == 3) {
if($list ==1){$listset = "1st"; $lbg ="linear-gradient(#b75bb1 0%, #1e5799 100%);";} 
if($list ==2){$listset = "2nd";   $lbg ="linear-gradient(#b7895b 0%, #1e5799 100%);"; } 
if($list ==3){$listset = "3rd";  $lbg ="linear-gradient(#5bb7a5 0%, #1e5799 100%);";} 
       ?><div class="ribbon blue" ><span  style="background:<?php 
       echo$lbg; ?>"><?php echo$listset; ?></span></div> <?php }?>
                                                   <div class="badge badge-primary text-wrap " style="width: 6rem;color:#636f83;font-weight:light; font-size:8px;"> TOP <?php echo$list; ?> HIGHTEST</div>
<br>
<div class="badge badge-primary text-wrap w-100" style="width: 6rem;color:#636f83;font-weight:light; font-size:10px;"> Total OF <?php echo$gtbill; ?> Bills Collected </div>
<br>
 ...
 echo$name;
  ...
  ?></div>
    <div class="name">Total Collection
    <br><b>
     <?php
...
echo number_format($totalcol/100, 2,'.',',');
 ?></b></div>
                                                     ...
                                                     <span style="font-size:11px;" >Percentage Of total Collection For the Month OF <?php echo $montset; ?>          <b><?php  $per = convertExponentialToDecimal($new_width);
  echo substr( $per, 0, 3);
 ?>% </b></span> 
   ...
   <p class="nav-title   text-center p-1 " style="font-size:12px;background-color:white;margin:0;color:black;font-weight:bolder;">TOP 5 HIGHTEST COLLECTION - COLLECTOR</p>
...
echo number_format($totalcol/100, 2,'.',',');
 ...
 <p class="nav-title   text-center p-1 " style="font-size:12px;background-color:white;margin:0;color:black;font-weight:bolder;">TOP 8 HIGHTEST COLLECTION - AGENT AND DEPUTIES</p>
...
echo number_format($totalcol/100, 2,'.',',');
 ...
 ?>% </b></span> 
  ...
  <p class="nav-title p-1  text-center" style="font-size:12px;background-color:white;margin:0;color:black;font-weight:bolder;">LIST OF AGENT, DEPUTIES AND COLLECTOR</p>
...
$new_width = (int)($percentage *100)/$totalWidth ; 
                  ...
                  ?>
                          ...
                          <td class=" text-center  box"   style="background-color:white;border:3px solid #ebedef;border-radius:10px;">
 <div class="btn-group">
    <button type="button" class="btn btn-default" ></button>
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="addlist.php?type=agent&ini=<?php echo$inionline; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
</svg> Add To Agents List</a></li>
      <li><a class="dropdown-item" href="addlist.php?type=teller&ini=<?php echo$inionline; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
</svg> Add To Teller List</a></li>
      <li><a class="dropdown-item" href="addlist.php?type=collector&ini=<?php echo$inionline; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
</svg> Add To Collector List</a></li>
    </ul>
    <button 
      type="button" 
      class="btn btn-default" 
      data-bs-toggle="dropdown" 
      aria-expanded="false"  style="float:right; margin-left:-390px; padding:0;"
...
<?php 
  ...
  $list =0;
$resultcoll1 = mysqli_query($db,"SELECT * FROM onlineaccount WHERE INI = '$inionline' ");
while ($coll1 = mysqli_fetch_array($resultcoll1))
{
if($coll1['TYPE'] == 'agent'){
    $list =1;
...
if($coll1['TYPE'] == 'collector'){
    $list =2;
}
}
if($list ==0){$listset = "None";  $lbg ="linear-gradient(#5bb7a5 0%, #1e5799 100%);";} 
if($list ==1){$listset = "Agent"; $lbg ="linear-gradient(#b75bb1 0%, #1e5799 100%);";} 
if($list ==2){$listset = "collector";   $lbg ="linear-gradient(#b7895b 0%, #1e5799 100%);"; } 

       ?><div class="ribbon blue text-wrap" ><span  style="background:<?php 
       echo$lbg; ?> font-size:9px;" ><?php echo$listset; ?></span></div>
                                                
                           <a id="badge"  href="timeline.php?huser='<?php echo$inionline; ?>'" target="_blank">
...
echo number_format($mtcoll/100, 2,'.',',');
 ?></b></div>
                                                     ...
                                                     <span style="font-size:11px;" >Percentage Of total Collection For the Month OF <?php echo $montset; ?>          <b></span><span class="badge badge-rounded-pill" style=" background-color:#157f91;font-size:9px;margin-top:-200px; ">  <?php
  //echo convertExponentialToDecimal($new_width);
  $per = convertExponentialToDecimal($new_width);
  echo substr( $per, 0, 3);
 ...
 <p class="nav-title   text-center p-2" style="font-size:12px;background-color:white;margin:0;font-weight:bolder;">SCHED. OF REMITTANCE FOR TODAY</p>
...
?>
   ...
   <p class="nav-title p-2  text-center "style="font-size:12px;background-color:#ebedef;margin:0;font-weight:bolder;" >COLLECTION CHART</p>
