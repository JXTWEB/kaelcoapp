...
//}
if($mode == "restricted"){
        echo ' <script> alert("Your account is unrestricted. Please click the link below to contact the developer for the registration of your account. Your account may not be able to access all features.");
    </script>';
}
if(!$user){
...
.header{
background: rgb(33,33,45);
background: linear-gradient(0deg, rgba(33,33,45,1) 7%, rgba(57,124,120,1) 88%);
...
<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-list" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5"/>
            ...
            <a class="nav-link" style="margin:0;padding-right:0;" >  <div class="avatar avatar-md"><img class="avatar-img"  style="" src="KaelcoLogo.png" alt="user@email.com"></div></a></li>
...
<label class="switch col-1 m-1" style="width:15px;">
     <a href="http://kaelco.000.pe/Upgrade/dist/dashboard.php?bg=<?php echo$link; ?>">
